...
#     f.imprimirlista(lista_personajes)
...
#         return True
#     if a==1:
#         f.atacar(lista_personajes)
#         return menu(lista_personajes)
#     if a==2:
#         f.añadir_aliado()
#         f.ciclo(lista_personajes,lista_de_iniciativa)
#         return menu(lista_personajes)
#     if a==3:
#         f.añadir_enemigo()
#         f.ciclo(lista_personajes,lista_de_iniciativa)
#         return menu(lista_personajes)
#     if a==4:
#         f.eliminar(lista_aliados,lista_enemigos,lista_personajes)
#         return menu(lista_personajes)
#     if a==5:
#         f.pasar_turno(lista_personajes)
#         return menu(lista_personajes)
#     if a==6:
#         f.Guardar(lista_personajes)
#         return menu(lista_personajes)
#     if a ==7:
#         f.Cargar()
#         return menu(lista_personajes)
